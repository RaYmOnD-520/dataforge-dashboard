    ...
    <div className="w-full">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="line-column-select" className="text-sm text-gray-400">
            Select column:
          </label>
          <select
            ...
            className="bg-gray-800 text-white border border-gray-700 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
